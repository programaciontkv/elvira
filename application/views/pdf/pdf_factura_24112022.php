    ...
    <tr>
        ...
        <td rowspan="2" width="52%">
            <table  id="encabezado2" width="100%">
                ...
                <tr>
                    <td colspan="2"> <b><?php echo utf8_encode('Número de Autorización:') ?> </b> </td>
                </tr>    
                <tr>
                    <td colspan="2"><?php echo $factura->fac_autorizacion?></td>
                </tr>    
                <tr>
                    <td colspan="2"> <b><?php echo utf8_encode('Fecha y hora de autorización:') ?> </b> </td>
                </tr>    
                <tr>    
                ...
                <tr>
                    <td colspan="2">  <b><?php echo utf8_encode('Emisión:') ?> </b>
                        <label style="font-weight: normal;">
                     Normal
                 </label>
             </td>
    ...
    <tr>    
        <td width="50%" valign="bottom">
            <table id="encabezado1"  width="100%">
                ...
                <tr>
                    <td colspan="2">
                      <b><?php echo utf8_encode('Teléfono:') ?> </b>
                     <label style="font-weight: normal;">
    ...
    <tr>
        <td colspan="2">
            <table id="detalle" style="" border="1"  width="100%" style="" class="table table-bordered table-list table-hover table-striped">
                <thead>
                    <tr >
                        <th  width="20%"> <b><?php echo utf8_encode('Código') ?> </b> </th>
                        <th style="width:70px"><b>Cantidad </b> </th>
                        <th width="38%"><b><?php echo utf8_encode('Descripción') ?> </b> </th>
