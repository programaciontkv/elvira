                                        ...
                                        <div class="panel panel-success col-sm-12">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="form-group <?php if(form_error('identificacion')!=''){ echo 'has-error';}?> ">
                                                            <input type="text" class="form-control"
                                                                name="identificacion" id="identificacion"
                                                                value="<?php if(validation_errors()!=''){ echo set_value('identificacion');}else{ echo $factura->fac_identificacion;}?>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="form-group <?php if(form_error('nombre')!=''){ echo 'has-error';}?> ">
                                                            <input type="text" class="form-control" name="nombre"
                                                                id="nombre"
                                                                value="<?php if(validation_errors()!=''){ echo set_value('nombre');}else{ echo $factura->fac_nombre;}?>">
                                                            <?php echo form_error("nombre","<span class='help-block'>","</span>");?>

                                                        </div>
                                                        <input type="hidden" class="form-control" name="cli_id"
                                                            id="cli_id"
                                                            value="<?php if(validation_errors()!=''){ echo set_value('cli_id');}else{ echo $factura->cli_id;}?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="form-group <?php if(form_error('direccion_cliente')!=''){ echo 'has-error';}?> ">
                                                            <input maxlength="80" type="text" class="form-control"
                                                                name="direccion_cliente" id="direccion_cliente"
                                                                value="<?php if(validation_errors()!=''){ echo set_value('direccion_cliente');}else{ echo $factura->fac_direccion;}?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="form-group <?php if(form_error('telefono_cliente')!=''){ echo 'has-error';}?> ">
                                                            <input type="text" class="form-control"
                                                                name="telefono_cliente" id="telefono_cliente"
                                                                value="<?php if(validation_errors('telefono_cliente')!=''){ echo set_value('telefono_cliente');}else{ echo $factura->fac_telefono;}?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="form-group <?php if(form_error('email_cliente')!=''){ echo 'has-error';}?> ">
                                                            <input type="email" class="form-control"
                                                                name="email_cliente" id="email_cliente"
                                                                value="<?php if(validation_errors()!=''){ echo set_value('email_cliente');}else{ echo $factura->fac_email;}?>">
                                ...
                                <div class="form-group <?php if(form_error('cli_parroquia')!=''){ echo 'has-error';}?> ">
                                  ...
                                  <?php echo form_error("cli_parroquia","<span class='help-block'>","</span>");?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="form-group <?php if(form_error('cli_ciudad')!=''){ echo 'has-error';}?> ">
                                                            <input type="text" class="form-control" name="cli_ciudad"
                                                                id="cli_ciudad"
                                                                value="<?php if(validation_errors()!=''){ echo set_value('cli_ciudad');}else{ echo $factura->cli_canton;}?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="form-group <?php if(form_error('cli_pais')!=''){ echo 'has-error';}?> ">
                                                            <input type="text" class="form-control" name="cli_pais"
                                                                id="cli_pais"
                                                                value="<?php if(validation_errors()!=''){ echo set_value('cli_pais');}else{ echo $factura->cli_pais;}?>">
                                ...
                                <td class="col-sm-10">
                                    <table class="table ">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="form-group <?php if(form_error('fac_fecha_emision')!=''){ echo 'has-error';}?> ">
                                                    <input type="date" class="form-control" name="fac_fecha_emision"
                                                        id="fac_fecha_emision"
                                                        value="<?php if(validation_errors()!=''){ echo set_value('fac_fecha_emision');}else{ echo $factura->fac_fecha_emision;}?>"
                                                        readonly>
                                                ...
                                                <input type="hidden" class="form-control" name="emp_id" id="emp_id"
                                                    value="<?php if(validation_errors()!=''){ echo set_value('emp_id');}else{ echo $factura->emp_id;}?>">
                                                <input type="hidden" class="form-control" name="emi_id" id="emi_id"
                                                    value="<?php if(validation_errors()!=''){ echo set_value('emi_id');}else{ echo $factura->emi_id;}?>">
                                                <input type="hidden" class="form-control" name="cja_id" id="cja_id"
                                                    value="<?php if(validation_errors()!=''){ echo set_value('cja_id');}else{ echo $factura->cja_id;}?>">
                                                <input type="hidden" class="form-control" name="ped_id" id="ped_id"
                                                    value="<?php if(validation_errors()!=''){ echo set_value('ped_id');}else{ echo $factura->ped_id;}?>">
                                            </td>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><input type="text" id="pag_documento<?php echo $m?>"
                                                    name="pag_documento<?php echo $m?>" class="form-control" size="10px"
                                                    lang="<?php echo $m?>" list="list_notas"
